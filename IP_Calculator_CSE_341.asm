...
;====================First host address calculation========================== 
    ...
    NAM netbin, ff1 ,ff2, ff3, ff4,ff5
...
;====================Wild card calculation==========================    
    ...
    ;printing wild card addrss 
    printn ""
    printn ""
    print "Wild Card Address: " 
    NAM wildmask, v1,v2,v3,v4,v5    
...
;=====================Credit========================== 
    ...
    printn "ID: 14301135" 
    GOTOXY 2,10
    printn "Email: mrasif30@gmail.com" 
    ...
    printn "ID: 14301115"   
    GOTOXY 43,10
    printn "Email: umarnasib13@gmail.com" 
    ...
    printn "ID: 14301054"  
    GOTOXY 23,18
    printn "Email: ajmaininqiadalam@gmail.com" 
